...
if(isset($_POST["save"])){ 
  ...
  if(!empty($_FILES["img"]["name"])) { 
      ...
      if(in_array($fileType, $allowTypes)){ 
          ...
          //$sql_insertfour = ("INSERT into products (reference, productName, price, qStock, img, createdDate) VALUES ('$ref','$pName','$price','$qStock','$imgContent', NOW())");
...
<head>
  ...
  <link href="assets/vendor/jquery/jquery.min.js" rel="stylesheet">
