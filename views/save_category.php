...
{
  $namec = $_POST["name"];
  $idfami = $_POST["id_cate"];
}

//requete d'insertion d'un fournissseur
$sql_insertcate = "INSERT INTO categorieproduit(nomCategorie, idFamille) VALUES ('$namec','$idfami')";
 if(mysqli_query($con,$sql_insertcate)) 
    echo "la Categorie  a ete enregistre";
  else
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Entrer le nom de la categorie" id="name" name="name">
                </div>
                <div class="form-floating mb-3">
                    <select class="form-select" id="id_cate" name="id_cate" aria-label="State">
